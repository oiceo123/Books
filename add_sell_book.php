...
<head>
    ...
    <link rel="stylesheet" href="add_sell_book.css">
    <title>Add Sell Book</title>
    <script>
        let xmlHttp;
        let statusBookName = false;
...
<body>
    ...
    <div class="container pb-4" style="margin-top: 141.5px; max-width: 500px;">
        ...
        <div class="row text-center">
            <div class="col">
                <h3>เพิ่มหนังสือที่ต้องการขาย</h3>
            </div>
        </div>
        ...
        <!-- Form -->
        <form action="save_book.php" method="post" enctype="multipart/form-data" onsubmit="checkUniqueInput(event)">
            <!-- Book Name -->
            <div class="row mb-3">
                <div class="col">
                    <label for="exampleFormControlInput1" class="form-label fw-bold">ชื่อหนังสือ <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="bookName" name="bookName" placeholder="กรุณากรอกชื่อหนังสือ" onblur="checkBookName()" required>
                </div>
            </div>
            <!-- Author Name -->
            <div class="row mb-3">
                <div class="col">
                    ...
                    <input type="text" class="form-control" id="authorName" name="authorName" placeholder="กรุณากรอกชื่อผู้แต่ง">
                </div>
            </div>
            <!-- Painter Name -->
            <div class="row mb-3">
                <div class="col">
                    ...
                    <input type="text" class="form-control" id="painterName" name="painterName" placeholder="กรุณากรอกชื่อผู้วาด">
                </div>
            </div>
            <!-- Book Detail -->
            <div class="row mb-3">
                <div class="col">
                    ...
                    <textarea class="form-control" id="bookDetail" name="bookDetail" rows="3" placeholder="กรุณากรอกรายละเอียดหนังสือ"></textarea>
                </div>
            </div>
            <!-- Series -->
            <div class="row mb-3">
                <div class="col">
                    ...
                    <input type="text" class="form-control" id="series" name="series" placeholder="กรุณากรอกชื่อซีรี่ย์">
                </div>
            </div>
            <!-- Category -->
            <?php
            $stmt = $conn->prepare("SELECT DISTINCT Category FROM book WHERE PublisherName = ?");
            ...
            <div class="row mb-3">
                <div class="col">
                    ...
                    <select class="form-select" id="category" name="category" onchange="selectCategory()" aria-label="Default select example" required>
                        <option value="" hidden>กรุณาเลือกหมวดหมู่ที่ต้องการ</option>
            ...
            <div class="row mb-3">
                <div class="col">
                    ...
                    <input type="text" class="form-control" id="price" name="price" pattern="[0-9]{1,4}\.[0-9]{2}|[0-9]{1,4}" title="ต้องกรอกเป็นตัวเลขเท่านั้น และ กรอกได้ตั้งแต่ 0-9999.99" placeholder="กรุณากรอกราคา ( หากฟรีให้กรอก 0 )" required>
                </div>
            </div>
            <!-- Book Cover Price -->
            <div class="row mb-3">
                <div class="col">
                    ...
                    <input type="text" class="form-control" id="bookCoverPrice" name="bookCoverPrice" pattern="[1-9][0-9]{0,3}\.[0-9]{2}|[1-9][0-9]{0,3}" title="ต้องกรอกเป็นตัวเลขเท่านั้น และ กรอกได้ตั้งแต่ 1-9999.99 หากไม่มีไม่ต้องกรอก" placeholder="กรุณากรอกราคาบนปกหนังสือ">
                </div>
            </div>
            <!-- Page -->
            <div class="row mb-3">
                <div class="col">
                    ...
                    <input type="text" class="form-control" id="page" name="page" pattern="[1-9][0-9]{0,10}" title="ต้องกรอกเป็นตัวเลขเท่านั้น ไม่ต่ำกว่า 1 และ กรอกได้ไม่เกิน 11 หลัก" placeholder="กรุณากรอกจำนวนหน้าของหน้งสือ" required>
                </div>
            </div>
            <!-- Book Cover Path -->
            <div class="row mb-3">
                <div class="col">
                    <label for="formFile" class="form-label fw-bold">รูปภาพหน้าปก <span class="text-danger">*</span></label>
                    <input class="form-control" type="file" id="bookCoverPath" name="bookCoverPath" accept="image/png, image/jpeg" required>
                </div>
            </div>
            <!-- Book Path -->
            <div class="row mb-3">
                <div class="col">
                    <label for="formFile" class="form-label fw-bold">ไฟล์หนังสือ (ไฟล์ pdf เท่านั้น) <span class="text-danger">*</span></label>
                    <input class="form-control" type="file" id="bookPath" name="bookPath" accept=".pdf" required>
                </div>
            </div>
            <!-- Book Sample Path -->
            <div class="row mb-4">
                <div class="col">
                    <label for="formFile" class="form-label fw-bold">ไฟล์ตัวอย่างหนังสือ (ไฟล์ pdf เท่านั้น) <span class="text-danger">*</span></label>
                    <input class="form-control" type="file" id="bookSamplePath" name="bookSamplePath" accept=".pdf" required>
                </div>
            </div>
            <!-- ปุ่มเพิ่มหนังสือ -->
            <div class="row justify-content-center">
                <div class="col-6">
                    <button class="btn btn-outline-success rounded-pill w-100 fw-bold hsubmit" type="submit">เพิ่มหนังสือ</button>
                </div>
            </div>
        </form>
    </div>
